...
from config.config import APIKEY, CHAT_MODEL, ASSIST_MODEL, SUM_MODEL
...
def initializeChatAi():
    ...
    memory = ConversationSummaryMemory(llm=chat_llm_path, input_key="input")
